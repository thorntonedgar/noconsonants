...
SECRET_KEY = config(
    'SECRET_KEY',
    default='django-insecure-n=7l$mfrv9wkfq&bowr#kdy3m7g+!tghg9-2*uw$5okwf#+bol'
)
...
ADMIN_SITE_HEADER = 'Edgar Thornton Resume Admin'
ADMIN_SITE_TITLE = 'Resume Admin'

# Caching - Use in-memory cache for development
